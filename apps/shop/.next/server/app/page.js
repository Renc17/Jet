    ...
    (e.modules = {
        ...
        let c = [
              ...
              children: [
                ...
                {},
                {
                  page: [
                    ...
                    '/Users/renc/Documents/dev/jet/apps/shop/src/app/page.tsx',
                  ],
                  metadata: {
                    icon: [
                      async e =>
                        (await Promise.resolve().then(r.bind(r, 154))).default(
                          e
                        ),
                    ],
                    apple: [],
            ...
            },
            {
              layout: [
                ...
                '/Users/renc/Documents/dev/jet/apps/shop/src/app/layout.tsx',
              ],
              'not-found': [
              ...
              metadata: {
                icon: [
                  async e =>
                    (await Promise.resolve().then(r.bind(r, 154))).default(e),
                ],
                apple: [],
                openGraph: [],
                twitter: [],
          ...
          l = ['/Users/renc/Documents/dev/jet/apps/shop/src/app/page.tsx'],
          f = '/page',
      ...
      7718: (e, t, r) => {
        ...
        function s({ children: e }) {
          return n.jsx('html', {
            lang: 'en',
            children: n.jsx('body', { className: o().className, children: e }),
          });
        }
      },
      151: (e, t, r) => {
          ...
          return r
            ? {
                params: (e = Object.keys(r.groups).reduce((o, a) => {
                  let s = e[a];
                  'string' == typeof s && (s = (0, l.normalizeRscURL)(s)),
                    Array.isArray(s) &&
                      (s = s.map(
                        e => (
                          'string' == typeof e &&
                            (e = (0, l.normalizeRscURL)(e)),
                          e
                        )
                      ));
                  let u = n[a],
                        ...
                        exec: o => {
                          ...
                          for (let e of Object.keys(a)) {
                            ...
                            e !== f.NEXT_QUERY_PARAM_PREFIX &&
                              e.startsWith(f.NEXT_QUERY_PARAM_PREFIX) &&
                              ((a[
                                e.substring(f.NEXT_QUERY_PARAM_PREFIX.length)
                              ] = t),
                              delete a[e]);
                          }
                          let u = Object.keys(i || {}),
